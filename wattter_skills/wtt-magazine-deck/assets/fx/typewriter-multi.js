...
(function(){
  ...
  window.HPX['typewriter-multi'] = function(el){
    ...
    wrap.style.cssText = 'position:absolute;inset:0;display:flex;flex-direction:column;justify-content:center;gap:14px;padding:32px 48px;font:600 22px ui-monospace,Menlo,monospace;color:var(--text-1,#e7e7ef);pointer-events:none;z-index:1;';
    el.appendChild(wrap);
    const rows = [];
    for (let li = 0; li < lines.length; li++){
      ...
      rows.push({row:row, span:span, txt:txt, i:0});
    }
